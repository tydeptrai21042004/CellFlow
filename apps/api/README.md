...
Versioned serverless API for projects, intents, tracking, submission, evidence and webhook configuration. Validate every boundary, enforce tenant isolation, keep network calls outside long DB transactions and return stable structured error codes.
