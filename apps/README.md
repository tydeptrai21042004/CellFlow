...
Contains deployable applications. Keep reusable logic out of apps; shared logic belongs in packages. Apps may compose packages but must not become the canonical implementation of domain rules.
