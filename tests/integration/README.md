...
Cover PostgreSQL repositories, API handlers, RPC adapters and workflow integration. Use controlled fixtures/mocks for deterministic CI plus optional real-testnet jobs.
