...
Exercise deployed-style flow: project -> API key -> intent -> track/submit -> reconcile -> webhook -> evidence. Include one browser test for dashboard visibility, but prioritize protocol correctness over UI snapshots.
