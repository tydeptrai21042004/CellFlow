...
Tests are part of the product evidence. Organize deterministic unit tests, real integration fixtures, explicit failure tests and full e2e flows. CI must not depend only on a flaky public RPC.
