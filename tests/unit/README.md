...
Cover pure state transitions, validation, canonicalization, signatures and repository rules. Fast and deterministic. State transition table should have exhaustive positive and negative cases.
