...
This folder differentiates CellFlow. Test RPC timeout, outage, ambiguous submit, duplicate intent, restart/redeploy, rejected tx, stale observations and webhook failures. Each scenario must declare expected invariant and evidence output.
