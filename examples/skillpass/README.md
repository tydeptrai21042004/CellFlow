...
Consumer #1. Replace one existing SkillPass transaction lifecycle with CellFlow. Document code removed/replaced, integration diff, failure evidence and lessons. Keep SkillPass-specific logic outside CellFlow packages.
