...
Consumer #2 must be independently maintained if possible. Choose a simple CKB app with real testnet transaction flow. Record maintainer feedback and avoid custom CellFlow behavior only for that project.
