...
All deployment artifacts and environment validation live here. Vercel is reference target; self-hosting can be added later without compromising the hosted architecture.
