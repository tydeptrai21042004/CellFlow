...
Provide deploy button metadata, environment schema, Neon setup, migrations, workflow configuration, health checks and smoke test. A new developer should deploy from a fork with no local infrastructure.
