...
Own the canonical lifecycle definition. Include transition table, terminal states, recovery transitions, source-of-truth rules and mapping from raw CKB RPC statuses. Any code change to states must update this folder first or in the same PR.
