...
Describe PostgreSQL entities, constraints, indexes, retention and tenant isolation. Include diagrams and migration rules. Explain why each field is required.
