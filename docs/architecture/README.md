...
Document boundaries among application, CCC, CellFlow, Vercel workflow, PostgreSQL, RPC and webhooks. Include context/container diagrams, deployment diagrams and ADRs. Every external dependency must have a failure-mode note.
