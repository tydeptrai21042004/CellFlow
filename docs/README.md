...
Keep architectural decisions, APIs, evidence and adoption material separated from implementation. Documentation must describe actual behavior of the matching release, not planned behavior.
