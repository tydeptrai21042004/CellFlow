...
Define evidence JSON format and reviewer verification process. Store examples from CI, failure scenarios and pilot applications. Evidence must distinguish observed chain facts from CellFlow-derived states.
