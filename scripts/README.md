...
Provide deterministic developer/reviewer commands: bootstrap, migrate, seed test project, run failure suite, export evidence and validate deployment. Scripts should fail fast and print actionable errors.
