...
Deliver signed state-change events with at-least-once semantics. Record attempts and backoff. Distinguish 4xx permanent configuration errors from retryable 5xx/network failures. Support test delivery.
