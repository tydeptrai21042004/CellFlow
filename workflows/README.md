...
Contains long-running/retryable business processes. Workflow steps must be idempotent, restart-safe and externally observable. Never rely on memory between steps.
