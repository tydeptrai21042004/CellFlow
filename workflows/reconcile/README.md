...
Poll/query CKB state using bounded exponential backoff and durable sleeps. Normalize raw response through core. Handle RPC unavailable/unknown without converting ambiguity into failure. Persist every meaningful transition.
