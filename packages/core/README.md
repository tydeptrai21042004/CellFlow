...
Implement states, transitions, normalized status, domain errors, intent/evidence types and pure transition functions. No database, network, Vercel or Next.js imports are allowed. This is the most stable public logic.
