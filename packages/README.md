...
All packages must be independently testable and have clear public surfaces. Avoid circular dependencies. Core must stay framework-free; higher-level packages can depend on core.
