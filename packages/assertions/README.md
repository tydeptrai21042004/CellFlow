...
V0.2+ package. Verify application-specific expected CKB outcomes after commitment, such as output type hash/lock args/data predicates. Keep disabled from V1 critical path until basic tracking is stable.
